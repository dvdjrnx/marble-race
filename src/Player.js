...
export default function Player() {
  ...
  const [smootCameraPosition] = useState(() => new THREE.Vector3(10, 10, 10))
  ...
  useFrame((state, delta) => {
    ...
    smootCameraPosition.lerp(cameraPosition, 5 * delta)
    smoothTargetPosition.lerp(cameraTarget, 5 * delta)

    state.camera.position.copy(smootCameraPosition)
